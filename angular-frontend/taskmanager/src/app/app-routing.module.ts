...
const routes: Routes = [
  ...
  { path: "tracker", component: TrackerViewComponent, canActivate: [AuthGuard] },
  { path: "trackers/:listID", component: TrackerViewComponent, canActivate: [AuthGuard] },
  { path: "tracker/new-list", component: NewListComponent, canActivate: [AuthGuard] },
  { path: "trackers/:listID/new-list", redirectTo: "tracker/new-list", canActivate: [AuthGuard] },
  { path: "tracker/new-list/tracker", redirectTo: "tracker", canActivate: [AuthGuard] },
  { path: "trackers/:listID/new-task", component: NewTaskComponent, canActivate: [AuthGuard] },
  { path: 'edit-list/:listID', component: EditListComponent, canActivate: [AuthGuard] },
  { path: 'edit-list/:listID/tracker', redirectTo: 'trackers/:listID', canActivate: [AuthGuard] },
  { path: 'trackers/:listID/edit-task/:taskID', component: EditTaskComponent, canActivate: [AuthGuard] },
  { path: 'trackers/:listID/edit-task/:taskID/tracker', redirectTo: 'trackers/:listID', canActivate: [AuthGuard] },
  ...
  { path: 'trackers/:listID/add-description/:taskID', component: AddDescriptionComponent },
